...
TELEGRAM_SUPPORT_CHAT_ID=  # channel_id where the bot will forward all incoming messages
TELEGRAM_SUPERCHAT_ID=  # superchat_id where the bot will forward all incoming messages
